        ...
        <body>
            ...
            <div class="topbar">
                    ...
                    <div class="user">
                        <img src="images/me.jpeg" class="image" alt="" >
                    </div>
                </div>
                <div class="sidebar">
                <ul>
        ...
        <div class="card-body1">
            ...
            if(isset($_POST['submit'])){
                $name = $_POST['search'];
                $select_users = mysqli_query($conn, "SELECT * FROM `products` WHERE name LIKE '%{$name}%'") or die('query failed');
        ...
        ?>
                ...
                <div class="card-header">
                    <center><h2 class="display-6 text-center">Inventory</h2>
                </div>
                <div class="card-body">
        ...
        ?>
        <tr>
    <td style="width: 150px; height: 150px;"><?php echo $row['product_name']; ?></td>
    <td style="width: 150px; height: 150px;"><img class="image" src="uploads/<?php echo $row['image']; ?>" alt=""></td>
    <td style="width: 150px; height: 150px;">
        <?php
        if ($row['stocks'] > 0) {
            echo $row['stocks'];
        } else {
            echo "<a href='products.php?product_id=" . $row['id'] . "' style='color: red;'>Out of Stock</a>";
        }
        ?>
    </td>
    <td style="width: 150px; height: 150px;"><?php echo $row['price']; ?></td>
    <td style="width: 150px; height: 150px;"><?php echo $row['date_added']; ?></td>
</tr>
